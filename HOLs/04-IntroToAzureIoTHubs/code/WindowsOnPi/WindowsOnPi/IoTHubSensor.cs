...
namespace WindowsOnPi
{
  ...
  public class IoTHubSensor
  {
    ...
    public IoTHubSensor(string guid, string displayname, string measurename, string unitofmeasure)
    {
      this.guid = guid;
    ...
    {
      DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(IoTHubSensor));
